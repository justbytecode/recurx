    ...
    <div className="flex min-h-screen bg-black">
      ...
      <div className="flex-1 p-4 sm:p-6 md:p-8 lg:p-10 max-w-[100vw] overflow-x-hidden text-white">
        <header className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold">KYB Verification</h1>
        </header>
        <Card className="shadow-lg bg-gray-900 rounded-xl border-none">
          <CardHeader>
            <CardTitle className="text-lg font-semibold text-white">KYB Status</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-gray-400">
              KYB Verification is an upcoming feature and is not yet available.
            </p>
          </CardContent>
        </Card>
      </div>
